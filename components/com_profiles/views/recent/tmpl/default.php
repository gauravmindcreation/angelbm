...
<?php foreach($this->families as $family) : ?>
	<li>
		...
		if(is_file(JPATH_SITE.'/uploads/recents/'.$family->id.'/165_120_'.$family->recent_story_image))
		{
			echo '<img src="/uploads/recents/'.$family->id.'/165_120_'.$family->recent_story_image.'" alt="'.$family->last_name.' Family" />';
		}
		else
		{
