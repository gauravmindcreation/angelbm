...
/*
(function($){
   $("div.svwp").prepend("<img src='images/svwloader.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path   
})(jQuery);
*/
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsActiveBorderColor: "#CC66CC",
	...
	return this.each(function(){
		...
		var pictWidth = 310; //container.find("img").attr("width");
		var pictHeight = 220; //container.find("img").attr("height");
    ...
    .wrap(jQuery("<div style='"+ pictWidth +" overflow: hidden; position: relative; top: 0; left: 0'>"));
